...
## Phase 1: Core Construction (Current)
- [x] Claim Ingestion & Reconciliation Engine (Atomic DB transactions)
- [x] Pre-Scrubbing Rules Engine (Gender/Age validation)
- [x] Database-level PHI Encryption & Read-Access Logging
- [x] Modular Bot Adapters interface
- [ ] **RPA Submission Engine Implementation**: Web scraping bots for Discovery and Medscheme.
- [ ] **Automated eRA Fetching**: Background tasks to download remittances via RPA.
- [ ] **Collections & Patient Invoicing**: Tracking patient liability and generating statements.
- [ ] **UI/UX Dashboards**: Visual tracking for claims, bot logs, and scrubbing errors.

## Phase 2: Beta Launch Readiness
...
- [ ] **PAIA / POPIA Manual**: Draft and publish a public manual detailing data processing, subjects, and security measures (similar to GoodX).
...
- [ ] **Expansion into Financial Services (Collections)**: Integrate with credit bureaus and debt collection agencies.
